...
/* $Id: statgrab.c 297236 2010-03-31 20:39:48Z johannes $ */
...
PHP_MINFO_FUNCTION(statgrab)
{
	...
	php_info_print_table_header(2, "Extension version", PHP_STATGRAB_VERSION " - ($Id: statgrab.c 297236 2010-03-31 20:39:48Z johannes $)");
